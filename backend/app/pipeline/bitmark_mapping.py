...
LABEL_TO_BITMARK: Dict[str, Dict[str, Any]] = {
    ...
    "numbered_list_single": {
        "bitmark_type": "article",
        "description": "Single-level ordered list item (orderedList node in bitmark++ body)",
        "ordered": True,
        "nested": False,
    },
    "numbered_list_nested": {
        "bitmark_type": "article",
        "description": "Nested ordered list item (orderedList node in bitmark++ body)",
        "ordered": True,
        "nested": True,
    },
    "bulleted_list_single": {
        "bitmark_type": "article",
        "description": "Single-level unordered list item (bulletList node in bitmark++ body)",
        "ordered": False,
        "nested": False,
    },
    "bulleted_list_nested": {
        "bitmark_type": "article",
        "description": "Nested unordered list item (bulletList node in bitmark++ body)",
        "ordered": False,
        "nested": True,
    },
    "block_element": {
    ...
    "table": {
        "bitmark_type": "article",
        "description": "Table data row (rendered as paragraph in bitmark++ body; structured data in bitmark_extension)",
        "extension_note": "No dedicated Bitmark table bit type; stored as article with table details in bitmark_extension",
    },
    "table_header_row": {
        "bitmark_type": "article",
        "description": "Table header row (rendered as paragraph in bitmark++ body; structured data in bitmark_extension)",
        "is_header": True,
        "extension_note": "No dedicated Bitmark table bit type; stored as article with table details in bitmark_extension",
    },
    "table_caption": {
    ...
    "image": {
        "bitmark_type": "article",
        "description": "Image or figure (inline image node in bitmark++ body)",
        "extension_note": "Rendered as an image node inside an article bit body",
    },
